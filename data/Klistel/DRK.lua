...
function init_gear_sets()
    ...
    gear.Ody_FC_legs = {name="Odyssean Cuisses", augments={'Attack+5','"Fast Cast"+6','Accuracy+10',}}
    ...
    sets.precast.WS['Shockwave'] = sets.precast.WS
    --Klistel: I'm making shockwave just link back to your baseline WS for now, but below is what is recommended by the LUA creator
    --{
    --    ammo="Knobkierrie",
    --    head="Heath. Bur. +3",
    --    body="Fall. Cuirass +3",
