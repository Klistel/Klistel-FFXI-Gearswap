...
function init_gear_sets()
    ...
    gear.Adhemar_B_feet = {name="Adhemar Gamashes +1", augments={'DEX+12','AGI+12','Accuracy+20',}}
    ...
    gear.AF_Head="Pillager's Bonnet"
    gear.AF_Body="Pillager's Vest"
    gear.AF_Hands="Pillager's Armlets"
    gear.AF_Legs="Pillager's Culottes"
    gear.AF_Feet="Pillager's Poulaines"

    gear.Relic_Head="Plunderer's Bonnet"
    gear.Relic_Body="Plunderer's Vest"
    gear.Relic_Hands="Plunderer's Armlets"
    gear.Relic_Legs="Plunderer's Culottes"
    gear.Relic_Feet="Plunderer's Poulaines"

    gear.Empy_Head="Skulker's Bonnet"
    gear.Empy_Body="Skulker's Vest"
    gear.Empy_Hands="Skulker's Armlets"
    gear.Empy_Legs="Skulker's Culottes"
    gear.Empy_Feet="Skulker's Poulaines"
    ...
    sets.TreasureHunter = {
        ...
        hands=gear.Relic_Hands, --4
        feet=gear.Empy_Feet, --3
        waist="Chaac Belt", --1
        }
    ...
    sets.precast.JA['Accomplice'] = {head=gear.Empy_Head}
    sets.precast.JA['Aura Steal'] = {head=gear.Relic_Head}
    sets.precast.JA['Collaborator'] = set_combine(sets.TreasureHunter, {head=gear.Empy_Head})
    sets.precast.JA['Flee'] = {feet=gear.AF_Feet}
    sets.precast.JA['Hide'] = {body=gear.AF_Body}
    sets.precast.JA['Conspirator'] = set_combine(sets.TreasureHunter, {body=gear.Empy_Body})
    ...
    sets.precast.JA['Despoil'] = {ammo="Barathrum", legs=gear.Empy_Legs, feet=gear.Empy_Feet}
   ...
   sets.idle.Refresh = set_combine(sets.idle, {
    ...
    sets.buff['Ambush'] = {body=gear.Relic_Body}
