...
------------------------------------------------------------------------------------------------
        ...
        sets.precast.JA['Divine Emblem'] = set_combine(sets.Enmity,{feet=gear.Empy_Feet})
        ...
        sets.precast.JA['Holy Circle'].DT = set_combine(sets.Enmity.DT,{feet=gear.AF_Feet})
        ...
        sets.precast.JA['Divine Emblem'].DT = set_combine(sets.Enmity.DT,{feet=gear.Empy_Feet})
        ...
        sets.Knockback = {}
        sets.MP = {head=gear.Empy_Head,neck="Coatl Gorget +1",ear2="Ethereal Earring",waist="Flume Belt +1",feet=gear.AF_Feet}
        sets.passive.AbsorbMP = {head=gear.Empy_Head,neck="Coatl Gorget +1",ear2="Ethereal Earring",waist="Flume Belt +1",feet=gear.AF_Feet}
        sets.MP_Knockback = {}
