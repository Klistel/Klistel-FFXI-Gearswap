...
sets.idle.th = {ammo = "Perfect Lucky Egg", feet = "Volte Boots"}
...
sets.perp.Carbuncle = {hands = "Asteria Mitts +1", feet = "Herald's Gaiters"}
sets.perp.Cait = {hands = "Lamassu Mitts +1"}
...
sets.precast.BloodPact["Shock Squall"] =
    set_combine(sets.precast.BloodPact, {
...
sets.summonmagic = {body = "Baayami Robe +1"}

sets.precast.JA['Astral Flow'] = {head = gear.Relic_Head}
sets.fastfeet = {feet = "Herald's Gaiters"}

sets.precast.Cure = {back = "Pahtli cape"}
...
sets.midcast.Pet.PhysicalBloodPactRage = {
    ...
    hands = {
        ...
        augments = {
            'Pet: Attack+27 Pet: Rng.Atk.+27', 'Blood Pact Dmg.+8',
            'Pet: INT+2', 'Pet: "Mag.Atk.Bns."+13'
        }
    },
...
sets.midcast.Pet.MagicalBloodPactRage = {
    ...
    hands = {
        name = "Merlinic Dastanas",
        augments = {
            'Pet: Mag. Acc.+14 Pet: "Mag.Atk.Bns."+14', 'Blood Pact Dmg.+10',
            'Pet: Mag. Acc.+4'
        }
    },
...
sets.midcast.Pet.MagicalBloodPactRage.Sp =
