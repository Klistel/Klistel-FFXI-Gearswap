    ...
    ------------------------------------------------------------------------------------------------
        ...
        sets.midcast.RA = {
           ammo=gear.RAbullet,
            ...
            neck="Iskur Gorget",
        --    ear1="Crep. Earring",         Shinryu HTBF
            ear2="Telos Earring",
        --    ring1="Crepuscular Ring",     Shinryu HTBF
            ring1={name="Chirich Ring +1", bag="wardrobe2"},
            ring2="Ilabrat Ring",
            back=gear.COR_RA_Cape,
            waist="Yemaya Belt",
    ...
    ------------------------------------------------------------------------------------------------
        ...
        sets.TreasureHunter = {
            feet="Volte Boots",
            waist="Chaac Belt",
            hands={ name="Herculean Gloves", augments={'Accuracy+7','Pet: STR+3','"Treasure Hunter"+1',}},
            head={ name="Herculean Helm", augments={'MND+4','Weapon skill damage +4%','"Treasure Hunter"+1','Mag. Acc.+8 "Mag.Atk.Bns."+8',}},
        }
