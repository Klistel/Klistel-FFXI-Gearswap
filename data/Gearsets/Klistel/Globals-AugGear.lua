    ...
    gear.COR_TP_Cape = {name="Camulus's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10','Damage taken-5%',}} --**
    gear.COR_WS_MAB_Cape = {name="Camulus's Mantle", augments={'AGI+20','Mag. Acc+20 /Mag. Dmg.+20','AGI+10','Weapon skill damage +10%',}} --*
    gear.COR_WS_MELEE_Cape = { name="Camulus's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%','Damage taken-5%',}} --**
    gear.COR_WS_RA_Cape = {name="Camulus's Mantle", augments={'AGI+20','Rng.Acc.+20 Rng.Atk.+20','AGI+10','Weapon skill damage +10%',}} --*
    gear.COR_FC_Cape = { name="Camulus's Mantle", augments={'AGI+20','Eva.+20 /Mag. Eva.+20','Evasion+6','"Fast Cast"+10',}} --


    gear.DRG_TP_Cape = {name="Brigantia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10','Damage taken-5%',}} --**
    gear.DRG_JMP_Cape = {name="Brigantia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','"Store TP"+10','Damage taken-5%',}} --**
    gear.DRG_WS_STR_WSD_Cape = {name="Brigantia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}} -- *
    gear.DRG_WS_STR_DA_Cape = {name="Brigantia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','"Dbl.Atk."+10',}} -- *

    gear.DRG_WS_DEX_WSD = {name="Brigantia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Weapon skill damage +10%',}} --not done 'DEX+10' Dye
    gear.DRG_WS_STR_CRIT = {name="Brigantia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','Crit.hit rate+10',}} --not done 'STR+10' Dye
    gear.DRG_Haste_Cape = {name="Brigantia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Haste +10','Damage taken-5%',}} -- not done


    gear.SMN_PhysCape = { name="Campestres's Cape", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Pet: Attack+10 Pet: Rng.Atk.+10','Pet: Haste+10','Damage taken-5%',}}
    gear.SMN_MagCape = { name="Campestres's Cape", augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Pet: Magic Damage+10','Haste+10','Damage taken-4%',}}
    gear.SMN_FC_Cape= { name="Campestres's Cape", augments={'AGI+20','Eva.+20 /Mag. Eva.+20','"Fast Cast"+5',}}


    gear.PLD_Enmity_Cape= {name="Rudianos's Mantle",augments={'HP+60','Eva.+20 /Mag. Eva.+20','HP+20','Enmity+10',}}
    gear.PLD_DD_TP_Cape = {name="Rudianos's Mantle",augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10','Damage taken-5%',}}
    gear.PLD_WSD_Cape = {name="Rudianos's Mantle",augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}
    gear.PLD_FC_Cape = {name="Rudianos's Mantle",augments={'INT+20','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','"Fast Cast"+10',}}
    ...
    gear.Valo_TP_body = { name="Valorous Mail", augments={'Accuracy+20 Attack+20','"Dbl.Atk."+3','Attack+3',}}
    gear.Valo_STP_legs = { name="Valorous Hose", augments={'Accuracy+23 Attack+23','"Store TP"+1','AGI+7','Attack+11',}}
    gear.Valo_TP_legs = { name="Valorous Hose", augments={'Accuracy+23 Attack+23','"Store TP"+1','AGI+7','Attack+11',}} -- this is a placeholder for DA legs, need to make another pair

    -- Herculean  
    gear.Herc_TA_feet = {name="Herculean Boots", augments={'Accuracy+13 Attack+13','"Triple Atk."+4','STR+1','Attack+5',}}
    ...
    gear.Taeon_Phalanx_body = { name="Taeon Tabard", augments={'Mag. Evasion+18','Spell interruption rate down -9%','Phalanx +3',}}
    gear.Taeon_Phalanx_feet = { name="Taeon Boots", augments={'Mag. Evasion+19','Spell interruption rate down -8%','Phalanx +3',}}
    ...
    gear.Souveran_D_Head = { name="Souv. Schaller +1", augments={'HP+105','VIT+12','Phys. dmg. taken -4',}}
